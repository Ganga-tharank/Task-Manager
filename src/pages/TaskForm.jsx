...
const TaskForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    try {
      ...
      if (title.length > 300) {
        throw new Error('Maximum number of characters for the title is 300');
      }
            ...
            <div className='max-w-md mx-auto space-y-6'>
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="number" className="p-1 mt-2 mb-4 w-full bg-slate-200 rounded"
                        ...
                        required
                    />
                    <button type="submit" className="mt-3 mx-auto block px-4 py-2 rounded-md bg-teal-500 text-white font-bold">Submit</button>
                </form>
            </div>
        </div>
    </div>
